 ...
 */
public class InternetImageReaderServlet extends HttpServlet {
    ...
    private void writeInternetImage(String imagePath , OutputStream outputStream) {
        ...
        String localFilePath = this.getClass().getClassLoader().getResource("").getPath() + "/statics/images/not_found_64.jpg";
        try {
