/**
 * chendd自定义，将module.js、hotkeys.js、simditor.js整合为simditor.all.js并压缩而来
 */
...
(function (root, factory) {
    ...
    Toolbar = (function(superClass) {
        ...
        Toolbar.prototype._init = function() {
            ...
            console.log(this.opts.toolbarHidden + "--" + !this.opts.toolbarHidden);
            console.log(this.opts.toolbarFloat);
    ...
    ImageButton = (function(superClass) {
        ...
        ImageButton.prototype.createImage = function(name) {
            ...
            range.deleteContents();
            this.editor.selection.range(range);
            $img = $('<img/>').attr('alt', name).attr('src', this.defaultImage);
